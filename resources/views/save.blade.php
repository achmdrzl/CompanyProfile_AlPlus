                                    ...
                                    <nav id="site-navigation" class="main-navigation">
                                        <ul class="menu">
                                            <li class="menu-item-has-children current-menu-item current-menu-ancestor">
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="current-menu-item"><a href="index.html">Main Home</a>
                                                    </li>
                                            ...
                                            <li class="menu-item-has-children mega-dropdown"><a
                                                    href="#">Portfolio</a>
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        <ul class="col">
                                                            ...
                                                            <li><a href="portfolio-metro-no-gap.html">Portfolio Metro
                                                                    No Space</a></li>
                                                        ...
                                                        <ul class="col">
                                                            ...
                                                            <li><a href="portfolio-three-column.html">Three Columns</a>
                                                            </li>
                                                            <li><a href="portfolio-three-column-wide.html">Three
                                                                    Columns Wide</a></li>
                                                            <li><a href="portfolio-four-column-wide.html">Four Columns
                                                                    Wide</a></li>
                                                            <li><a href="portfolio-five-column-wide.html">Five Columns
                                                                    Wide</a></li>
                                                        </ul>
                                                        <ul class="col">
                                                        ...
                                                        <ul class="col">
                                                            ...
                                                            <li><a href="show-overlay-info.html">Show Overlay Info</a>
                                                            </li>
                                ...
                                <div class="octf-col cta-col text-right no-padding">
                                    ...
                                    <div class="octf-btn-cta">
                                        ...
                                        <div class="octf-cart octf-cta-header">
                                            <a class="cart-contents" href="cart-page.html"
                                        ...
                                        <div class="mobile-nav">
                                            <ul id="menu-main-menu" class="mobile_mainmenu none-style">
                                                <li
                                                    ...
                                                    <a href="index.html">Home</a>
                                                    <ul class="sub-menu">
                                                        <li class="current-menu-item"><a href="index.html">Main
                                                                Home</a></li>
                                                        <li><a href="index-2.html">Interior Design</a></li>
                                                        <li><a href="index-3.html">Studio Home</a></li>
                                                        <li><a href="index-4.html">Architecture Agency</a></li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li class="menu-item-has-children"><a href="#">Portfolio
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li><a href="portfolio-gallery.html">Portfolio
                                                                        Gallery</a></li>
                                                                <li><a href="portfolio-slider.html">Portfolio
                                                                        Slider</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item-has-children"><a href="#">Portfolio
                                                        ...
                                                        <li class="menu-item-has-children"><a
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li><a href="hidden-overlay-info.html">Hidden Overlay
                                                                        Info</a></li>
                                                                <li><a href="background-solid.html">Background
                                                                        Solid</a></li>
                                                                <li><a href="hidden-1.html">Hidden 1</a></li>
                                                                <li><a href="hidden-2.html">Hidden 2</a></li>
                                                            </ul>
        ...
        <div id="content" class="site-content">
            <div class="p-0">
                ...
                <div id="rev_slider_one_wrapper" class="rev_slider_wrapper fullscreen-container"
                    ...
                    <div id="rev_slider_one" class="rev_slider fullscreenbanner" style="display:none;"
                        data-version="5.4.1">
                        <ul>
                            ...
                            <li data-index="rs-70" data-transition="fade" data-slotamount="default"
                                ...
                                data-thumb="https://via.placeholder.com/1920x950.png" data-rotate="0"
                                data-saveperformance="off" data-title="" data-param1="1" data-param2=""
                                ...
                                <img src="https://via.placeholder.com/1920x950.png" data-bgcolor='rgba(255,255,255,0)'
                                    ...
                                    class="rev-slidebg" data-bgrepeat="no-repeat" data-bgparallax="off"
                                    data-no-retina>
                                ...
                                <div class="tp-caption tp-resizeme tp-caption-main" id="slide-70-layer-2"
                                    ...
                                    data-fontweight="['200','200','200','200']" data-whitespace="nowrap"
                                ...
                                <div class="tp-caption tp-resizeme tp-desc" id="slide-70-layer-3"
                                    ...
                                    data-y="['center','center','center','center']"
                                    data-voffset="['54','43','31','15']" data-fontsize="['19','18','17','16']"
                                    data-lineheight="['33','27','28','24']" data-width="['818','630','500','417']"
                                    data-weight="['500','500','500','500']" data-color="['#fff','#fff','#fff','#fff']"
                                ...
                                <div class="tp-caption rev-btn" id="slide-70-layer-4"
                                    ...
                                    data-paddingleft="[0,0,0,0]"><a href="portfolio-masonry.html"
                            ...
                            <li data-index="rs-71" data-transition="fade" data-slotamount="default"
                                ...
                                data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="https://via.placeholder.com/1920x950.png" data-bgcolor='#ffffff'
                                    style='' alt="" data-bgposition="center center" data-bgfit="cover"
                                    data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="off"
                                    data-no-retina>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div
                                ...
                                <div class="icon-main"><img src="https://via.placeholder.com/74x84.png"
                                        alt=""></div>
