        ...
        <div class="dcell">
            <div class="container">
                ...
                <ul id="breadcrumbs" class="breadcrumbs none-style">
                    ...
                    <li class="active">Citraland Surabaya</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
                        ...
                        <div id="gallery-2" class="gallery gallery-columns-1 s2">
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a href="{{ asset('assets/images/projects/SK HOUSE/(11759)SEIKO2_000.png') }}">
                                        <img src="{{ asset('assets/images/projects/SK HOUSE/(11759)SEIKO2_000.png') }}"
                                            alt="">
                            ...
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a href="{{ asset('assets/images/projects/SK HOUSE/(11759)SEIKO2_001.png') }}">
                                        <img src="{{ asset('assets/images/projects/SK HOUSE/(11759)SEIKO2_001.png') }}"
                                            alt="">
                                        <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </a>
                                </div>
                            ...
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a href="{{ asset('assets/images/projects/SK HOUSE/(11759)SEIKO2.png') }}">
                                        <img src="{{ asset('assets/images/projects/SK HOUSE/(11759)SEIKO2.png') }}"
                                            alt="">
                                        <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p> The client had references from interior designers from across the globe – the brief was to make
                        everything luxurious and glamorous. Emphasizing on the beauty of aged wood texture and golden
                        linings, this project stood differently than the others, elegant and charming on its own.</p>
