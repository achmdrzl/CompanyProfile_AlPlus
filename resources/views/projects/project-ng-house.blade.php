...
@section('content')
    <div class="page-header dtable text-center header-transparent pheader-portfolio-detail-nghouse">
        <div class="dcell">
            <div class="container">
                <h1 class="page-title">NG House Pagesangan</h1>
                <ul id="breadcrumbs" class="breadcrumbs none-style">
                    <li><a href="index.html">Home</a></li>
                    <li><a href="portfolio-masonry.html">Portfolio</a></li>
                    <li class="active">NG House Pagesangan</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
                        ...
                        <div id="gallery-2" class="gallery gallery-columns-1 s2">
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a
                                        href="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/NG-house/1170-2_iRJm4vn8-.png?updatedAt=1707445619947">
                                        <img src="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/NG-house/1170-2_iRJm4vn8-.png?updatedAt=1707445619947"
                                            alt="">
                            ...
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a
                                        href="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/NG-house/1170_Bz57zGLpM.png?updatedAt=1707445619926">
                                        <img src="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/NG-house/1170_Bz57zGLpM.png?updatedAt=1707445619926"
                                            alt="">
                                        <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </a>
                                </div>
                            ...
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a
                                        href="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/NG-house/1170-3_vgTpZZd2X.png?updatedAt=1707446291569">
                                        <img src="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/NG-house/1170-3_vgTpZZd2X.png?updatedAt=1707446291569"
                                            alt="">
                                        <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p> As the house itself is already painted in a tropical hue of orange, we decided to keep it simple. We
                        sticked with one wood pattern and mixed it with a calm whitish beige tone to add accent, while still
                        keeping it clean.</p>
