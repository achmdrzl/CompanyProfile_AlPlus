...
@section('content')
    <div class="page-header dtable text-center header-transparent pheader-portfolio-detail-lpetclinic">
        <div class="dcell">
            <div class="container">
                <h1 class="page-title">Ms. L Pet Clinic</h1>
                <ul id="breadcrumbs" class="breadcrumbs none-style">
                    <li><a href="index.html">Home</a></li>
                    <li><a href="portfolio-masonry.html">Portfolio</a></li>
                    <li class="active">Ms. L Pet Clinic</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="p-detail-info">
                        <h6>designer:</h6>
                        <p style="line-height: 1.5;">Almer NH., S. Ds & Eugenia Jessica, S. Ars.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="p-detail-info">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="p-detail-info">
                        <h6>project type::</h6>
                        <p>Pet Clinic Furniture Build</p>
                    </div>
                </div>
                        ...
                        <div id="gallery-2" class="gallery gallery-columns-1 s2">
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a
                                        href="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/Ms.%20L%20Pet%20Clinic/(11759)PET_6jZHQuWBN.png?updatedAt=1707442814653">
                                        <img src="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/Ms.%20L%20Pet%20Clinic/(11759)PET_6jZHQuWBN.png?updatedAt=1707442814653"
                                            alt="">
                            ...
                            <figure class="gallery-item">
                                <div class="gallery-icon portrait">
                                    <a
                                        href="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/Ms.%20L%20Pet%20Clinic/(11759)PET2_P83gVV5Bl.png?updatedAt=1707442814709">
                                        <img src="https://ik.imagekit.io/dxofqajmq/AlPlus%20Projects/Ms.%20L%20Pet%20Clinic/(11759)PET2_P83gVV5Bl.png?updatedAt=1707442814709"
                                            alt="">
                                        <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                    </a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p> Yes, everything – and we mean everything – could be constructed using 100% aluminium. Take this
                        project for example, where we create loving homes for our fur babies : small cats, big dogs, and
                        everything in between. The client’s brief was simple : They wanted everything to be made from
                        aluminum to accommodate easier cleaning and sterilization process.</p>
